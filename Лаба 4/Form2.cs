...
namespace Лаба_4
{
    public partial class Form2 : Form
    {
        ...
        public void one()
        {
            ...
            Pen graph = new Pen(Color.Purple, 2);
            do_graf(100, maxValue, oneDel, graph, center, stepbyoces, g);
        }

        public void do_graf(int numOfPoints, double maxValue, float oneDel, Pen penGraph, Point center, int stepbyoces, Graphics g)
        {
            ...
            for (int counter = 1; counter < numOfPoints; counter++)
            {
                g.DrawLine(penGraph, drawPoints[counter - 1].X, drawPoints[counter - 1].Y, drawPoints[counter].X, drawPoints[counter].Y);
                Thread.Sleep(25);
            }
