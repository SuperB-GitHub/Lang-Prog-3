namespace Third_Example
{
    partial class ChildForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            ChildTextBox.Margin = new Padding(3, 2, 3, 2);
            ChildTextBox.Name = "ChildTextBox";
            ChildTextBox.Size = new Size(240, 74);
            ...
            ChildWindowMenu.Padding = new Padding(5, 2, 0, 2);
            ChildWindowMenu.Size = new Size(240, 24);
            ChildWindowMenu.TabIndex = 1;
            ChildWindowMenu.Text = "menuStrip1";
            ChildWindowMenu.ItemClicked += ChildWindowMenu_ItemClicked;
            // 
            // FormatMenuItem
            // 
